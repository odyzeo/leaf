...
class Themify_Tiles_Updater {
	...
	public function admin_menu() {
		$hook = add_submenu_page(
			...
			__( 'Update Plugin', 'themify-tiles' ),
			__( 'Update Plugin', 'themify-tiles' ),
			'manage_options',
			'themify-tiles-update',
	...
	log</a> for details.</div>', 'themify-tiles'),
					...
					printf( __( '<div class="error"><p>Themify Tiles update is available. <a href="%s"> Update now. &#8594;</a></p></div>', 'themify-tiles' ), admin_url( 'edit.php?post_type=themify_tile&page=themify-tiles-update' ) );
				}
			}
			return;
		}
	...
	public function pormpt_box() { ?>
		...
		<div class="prompt-box">
			<div class="show-login">
				<form id="themify_update_form" method="post" action="edit.php?post_type=themify_tile&page=themify-tiles-update&action=upgrade&type=plugin&login=true">
...
add_action('wp_ajax_themify_builder_validate_login', 'themify_tiles_validate_login');