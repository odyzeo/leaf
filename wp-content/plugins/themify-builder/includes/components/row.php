		...
		if ( ! $echo ) {
			...
			ob_start();
                ...
                if(!Themify_Builder::$frontedit_active){
                    ...
                    if (!empty($row['column_alignment']) && $row['column_alignment']!=='col_align_top') {
                    ...
                    if($count>0){
                        ...
                        $is_right = false;
                        if($is_tablet){
                            $is_right = isset($row_content_attr['data-tablet_dir']);
                            if(isset($row_content_attr['data-col_tablet'])){
                                $row_content_classes[] = $row_content_attr['data-col_tablet'];
                            }
                        }
                        elseif($is_phone){
