...
final class Themify_Builder_Model {
	...
	static public function is_animation_active() {
		...
		if ( ( 'on' == themify_builder_get('builder_animation_mobile_exclude') && wp_is_mobile() ) 
			|| 'on' == themify_builder_get('builder_animation_disabled') ) {
			return false;
		} else {
			return true;
		}
	...
	static public function is_parallax_active() {
		// check if mobile exclude disabled OR disabled all transition
		if ( ( 'on' == themify_builder_get('builder_parallax_mobile_exclude') && wp_is_mobile() ) 
			|| 'on' == themify_builder_get('builder_parallax_disabled') ) {
			return false;
		} else {
			return true;
		}
