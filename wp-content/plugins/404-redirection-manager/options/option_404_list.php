...
$options = SRP_PLUGINS::get_options();
            ...
            <div class="col-sm-12">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <th class="btn btn-default table_header">404 Path</th>
                        ...
                        <th class="btn btn-default table_header" style="text-align: center">IP Address</th>
