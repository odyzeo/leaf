...
$phptabs->add_file_tab('Help','Help','option_help_center.php','file');
$phptabs->add_file_tab('Premium Features','Premium Features','premium.php','file');
$phptabs->run();
