...
/**
 * Module Name: Themify Post Slider
 * Description: Display slider content
 */
class SIN_Slider_Module extends Themify_Builder_Module {
	function __construct() {
		parent::__construct(array(
			'name' => __('SIN Slider', 'themify'),
			'slug' => 'themify-post-slider'
		));
	...
	public function get_options() {
		...
		$options = array(
			...
			array(
				...
				'type' => 'query_category',
				'label' => __('Blog Category', 'themify'),
				'options' => array(),
				'wrap_with_class' => 'tf-group-element tf-group-element-blog'
			),
			array(
				'id' => 'team_category_slider',
				'type' => 'query_category',
				'label' => __('Team Category', 'themify'),
				'options' => array(
...
// Module Options
///////////////////////////////////////
Themify_Builder_Model::register_module( 'SIN_Slider_Module' );