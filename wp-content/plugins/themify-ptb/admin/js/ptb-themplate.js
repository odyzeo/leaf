...
(function ($, window, document, undefined) {
    ...
    PTB = {
        ...
        DisableItems: function () {
            ...
            $('.ptb_change_disable input[type="radio"]:checked,.ptb_change_disable input[type="checkbox"]:checked,.ptb_change_disable select:selected').trigger('change');
        },
        ...
        ImageUpload: function (el) {
            ...
            ptb_cmb_image_file_frame.on('select', function () {
                ...
                $(el).prev().val(attachment.url);console.log(el);
