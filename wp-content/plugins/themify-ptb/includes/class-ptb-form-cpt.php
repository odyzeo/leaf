...
class PTB_Form_CPT {
    ...
    public function cpt_section_cb() {
        ...
        print( $this->generate_input_text(PTB_Custom_Post_Type::ID, $this->id, true));
    }
    ...
    public function cmb_section_cb() {
        ...
        print( '<div class="ptb-collapse-separator"></div>');
    }
    ...
    public function cl_section_cb() {
        ...
        print( '<div class="ptb-collapse"></div>');
    }
    ...
    private function add_fields_custom_labels() {
        ...
        foreach ($languages as $code => $lng) {
            ...
            $this->cpt->cl_add_new[$code] = isset($this->cpt->cl_add_new[$code]) && $this->cpt->cl_add_new[$code] ? $this->cpt->cl_add_new[$code] : __('Add New', 'ptb');
            $this->cpt->cl_add_new_item[$code] = isset($this->cpt->cl_add_new_item[$code]) && $this->cpt->cl_add_new_item[$code] ? $this->cpt->cl_add_new_item[$code] : __('Add New %s', 'ptb');
            $this->cpt->cl_edit_item[$code] = isset($this->cpt->cl_edit_item[$code]) && $this->cpt->cl_edit_item[$code] ? $this->cpt->cl_edit_item[$code] : __('Edit %s', 'ptb');
            $this->cpt->cl_new_item[$code] = isset($this->cpt->cl_new_item[$code]) && $this->cpt->cl_new_item[$code] ? $this->cpt->cl_new_item[$code] : __('New %s', 'ptb');
            $this->cpt->cl_all_items[$code] = isset($this->cpt->cl_all_items[$code]) && $this->cpt->cl_all_items[$code] ? $this->cpt->cl_all_items[$code] : __('All %s', 'ptb');
            $this->cpt->cl_view_item[$code] = isset($this->cpt->cl_view_item[$code]) && $this->cpt->cl_view_item[$code] ? $this->cpt->cl_view_item[$code] : __('View %s', 'ptb');
            $this->cpt->cl_search_items[$code] = isset($this->cpt->cl_search_items[$code]) && $this->cpt->cl_search_items[$code] ? $this->cpt->cl_search_items[$code] : __('Search %s', 'ptb');
            $this->cpt->cl_not_found[$code] = isset($this->cpt->cpt->cl_not_found[$code]) && $this->cpt->cl_not_found[$code] ? $this->cpt->cl_not_found[$code] : __('Not found.', 'ptb');
            $this->cpt->cl_not_found_in_trash[$code] = isset($this->cpt->cl_not_found_in_trash[$code]) && $this->cpt->cl_not_found_in_trash[$code] ? $this->cpt->cl_not_found_in_trash[$code] : __('Not found in Trash.', 'ptb');
            $this->cpt->cl_parent_item_colon[$code] = isset($this->cpt->cl_parent_item_colon[$code]) && $this->cpt->cl_parent_item_colon[$code] ? $this->cpt->cl_parent_item_colon[$code] : __('Parent %s:', 'ptb');
            $this->cpt->cl_menu_name[$code] = isset($this->cpt->cl_menu_name[$code]) && $this->cpt->cl_menu_name[$code] ? $this->cpt->cl_menu_name[$code] : __('%s', 'ptb');
        }
    ...
    public function post_type_is_hierarchical_cb() {
        ...
        print( $this->generate_input_radio_yes_no(
    ...
    public function add_fields_advanced_options_cb($args) {
        ...
        switch ($referrer) {
            ...
            case PTB_Custom_Post_Type::AD_MENU_ICON :
                ...
                printf($this->generate_select(
                                PTB_Custom_Post_Type::AD_MENU_ICON, $this->get_dashicons(), $this->cpt->ad_menu_icon, sprintf(__('View %s', 'ptb'), '<a href="https://developer.wordpress.org/resource/dashicons/#search" target="_blank">' . __('all icons', 'ptb') . '</a>')
                ));
                break;
