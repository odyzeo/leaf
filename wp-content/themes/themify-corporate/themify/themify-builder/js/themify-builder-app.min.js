...
b.each(c,function(){if(void 0!==a[this.name]&&this.value)a[this.name].push||(a[this.name]=[a[this.name]]),a[this.name].push(this.value);else if(this.value){var c=b("#themify_builder_lightbox_container #"+this.name);c.length&&void 0!==c.data("default")&&this.value==c.data("default")||(a[this.name]=this.value)}});return a});d.editing=!1;d.activeBreakPoint="desktop";d.Models.Module=Backbone.Model.extend({defaults:{elType:"module",mod_name:"",mod_settings:{}},initialize:function(){d.Models.Registry.register(this.cid,
this)},toRenderData:function(){return{slug:this.get("mod_name"),name:this.get("mod_name"),excerpt:this.getExcerpt()}},getExcerpt:function(){var a=this.get("mod_settings").content_text||this.get("mod_settings").content_box||"";return this.limitString(a,100)},limitString:function(a,c){a=this.stripHtml(a);return a.toString().length>c?a.toString().substr(0,c):a.toString()},stripHtml:function(a){var c=document.createElement("DIV");c.innerHTML=a;return c.textContent||c.innerText||""},setData:function(a){this.set(a,
{silent:!0});this.trigger("custom:change",this)},getPreviewSettings:function(){return _.extend({cid:this.cid},this.get("mod_settings"),this.get("temp_settings"))}});d.Models.SubRow=Backbone.Model.extend({defaults:{elType:"subrow",row_order:0,gutter:"gutter-default",column_alignment:"",fullwidthvideo:"",mutevideo:"",unloopvideo:"",desktop_dir:"ltr",tablet_dir:"ltr",mobile_dir:"ltr",col_mobile:"mobile-auto",col_tablet:"tablet-auto",cols:{},styling:{}},initialize:function(){d.Models.Registry.register(this.cid,
this)},setData:function(a){this.set(a,{silent:!0});this.trigger("custom:change",this)}});d.Models.Column=Backbone.Model.extend({defaults:{elType:"column",column_order:"",grid_class:"",component_name:"column",fullwidthvideo:"",mutevideo:"",unloopvideo:"",modules:{},styling:{}},initialize:function(){d.Models.Registry.register(this.cid,this)},setData:function(a){this.set(a,{silent:!0});this.trigger("custom:change",this)}});d.Models.Row=Backbone.Model.extend({defaults:{elType:"row",row_order:0,gutter:"gutter-default",
column_alignment:"",desktop_dir:"ltr",tablet_dir:"ltr",mobile_dir:"ltr",col_mobile:"mobile-auto",col_tablet:"tablet-auto",fullwidthvideo:"",mutevideo:"",unloopvideo:"",cols:{},styling:{}},initialize:function(){d.Models.Registry.register(this.cid,this)},setData:function(a){this.set(a,{silent:!0});this.trigger("custom:change",this)}});d.Collections.Rows=Backbone.Collection.extend({model:d.Models.Row});d.Models.Registry={items:{},register:function(a,c){this.items[a]=c},lookup:function(a){return this.items[a]||
null},remove:function(a){delete this.items[a]},destroy:function(){_.each(this.items,function(a,c){a.destroy()});this.items={};console.log("destroy registry")}};d.Models.setValue=function(a,c,b){b=b||!1;d.Models.Registry.lookup(a).set(c,{silent:b})};d.vent=_.extend({},Backbone.Events);d.Views.register_module=function(a,c){"default"!==a&&(this.Modules[a]=this.Modules["default"].extend(c))};d.Views.init_module=function(a,c){c=c||"default";_.isUndefined(a.mod_settings)&&!_.isUndefined(themifyBuilder.modules[a.mod_name].defaults)&&
(a.mod_settings=_.extend({},themifyBuilder.modules[a.mod_name].defaults));var b=a instanceof d.Models.Module?a:new d.Models.Module(a),f=new (this.get_module(c))({model:b,type:c});return{model:b,view:f}};d.Views.get_module=function(a){a=a||"default";return this.module_exists(a)?this.Modules[a]:this.Modules["default"]};d.Views.unregister_module=function(a){"default"!==a&&this.module_exists(a)&&delete this.Modules[a]};d.Views.module_exists=function(a){return this.Modules.hasOwnProperty(a)};d.Views.register_column=
function(a,b){"default"!==a&&(this.Columns[a]=this.Columns["default"].extend(b))};d.Views.init_column=function(a,b){b=b||"default";var c=a instanceof d.Models.Column?a:new d.Models.Column(a),f=new (this.get_column(b))({model:c,type:b});return{model:c,view:f}};d.Views.get_column=function(a){a=a||"default";return this.column_exists(a)?this.Columns[a]:this.Columns["default"]};d.Views.unregister_column=function(a){"default"!==a&&this.column_exists(a)&&delete this.Columns[a]};d.Views.column_exists=function(a){return this.Columns.hasOwnProperty(a)};
d.Views.register_subrow=function(a,b){"default"!==a&&(this.SubRows[a]=this.SubRows["default"].extend(b))};d.Views.init_subrow=function(a,b){b=b||"default";var c=a instanceof d.Models.SubRow?a:new d.Models.SubRow(a),f=new (this.get_subrow(b))({model:c,type:b});return{model:c,view:f}};d.Views.get_subrow=function(a){a=a||"default";return this.subrow_exists(a)?this.SubRows[a]:this.SubRows["default"]};d.Views.unregister_subrow=function(a){"default"!==a&&this.subrow_exists(a)&&delete this.SubRows[a]};d.Views.subrow_exists=
function(a){return this.SubRows.hasOwnProperty(a)};d.Views.register_row=function(a,b){"default"!==a&&(this.Rows[a]=this.Rows["default"].extend(b))};d.Views.init_row=function(a,b){b=b||"default";var c=a instanceof d.Models.Row?a:new d.Models.Row(a),f=new (this.get_row(b))({model:c,type:b});return{model:c,view:f}};d.Views.get_row=function(a){a=a||"default";return this.row_exists(a)?this.Rows[a]:this.Rows["default"]};d.Views.unregister_row=function(a){"default"!==a&&this.row_exists(a)&&delete this.Rows[a]};
d.Views.row_exists=function(a){return this.Rows.hasOwnProperty(a)};d.Views.BaseElement=Backbone.View.extend({type:"default",menuTouched:[],events:{"click .themify_builder_copy_component":"copy","click .themify_builder_paste_component":"paste","click .themify_builder_import_component":"import","click .themify_builder_export_component":"export","hover .module_menu":"actionMenuHover","hover .row_menu":"actionMenuHover"},initialize:function(a){_.extend(this,_.pick(a,"type"));this.listenTo(this.model,
"change",this.renderInlineData);this.listenTo(this.model,"custom:change",this.modelChange);this.listenTo(this.model,"destroy",this.remove);this.listenTo(this.model,"custom:dom:update",this.domUpdate)},modelChange:function(a){this.$el.attr(_.extend({},_.result(this,"attributes")));this.render()},remove:function(){this.$el.remove()},domUpdate:function(){this.setElement(b('[data-cid="'+this.model.cid+'"]'))},renderInlineData:function(){},copy:function(a){a.preventDefault();a.stopPropagation();console.log("copy");
var c=b(a.currentTarget);var e={};a=ThemifyBuilderCommon.detectBuilderComponent(c);switch(a){case "row":case "sub-row":c=c.closest(".themify_builder_"+a.replace("-","_"));var f=c.index();f="row"===a?d.Utils._getRowSettings(c,f):d.Utils._getSubRowSettings(c,f);e=JSON.stringify(f);"row"===a&&c.find(".themify_builder_dropdown").hide();break;case "module":c=c.closest(".active_module");e=c.data("mod-name");c=JSON.parse(c.find(".themify_module_settings").find('script[type="text/json"]').text());e=JSON.stringify({mod_name:e,
mod_settings:c});break;case "column":case "sub-column":e=c.closest(".themify_builder_col"),c=c.closest("column"===a?".themify_builder_row":".themify_builder_sub_row"),f=c.index(),f="column"===a?d.Utils._getRowSettings(c,f):d.Utils._getSubRowSettings(c,f),e=e.index(),e=f.cols[e],e=JSON.stringify(e)}ThemifyBuilderCommon.Clipboard.set(a,e)},paste:function(a){a.preventDefault();a.stopPropagation();console.log("paste");var c=b(a.currentTarget);a=ThemifyBuilderCommon.detectBuilderComponent(c);var e=ThemifyBuilderCommon.Clipboard.get(a);
if(!1===e)ThemifyBuilderCommon.alertWrongPaste();else if(ThemifyBuilderCommon.confirmDataPaste()){var f=this.$el.closest("[data-postid]"),e=JSON.parse(e);d.vent.trigger("dom:observer:start",f,{cid:this.model.cid,value:this.model.toJSON()});if("column"===a||"sub-column"===a){var h=c.closest(".themify_builder_col"),g=c.closest("column"===a?".themify_builder_row":".themify_builder_sub_row"),c=h.index(),g=g.index();e.column_order=c;e.grid_class=h.prop("class").replace("themify_builder_col","");"column"===
a?e.row_order=g:(e.sub_row_order=g,e.row_order=h.closest(".themify_builder_row").index(),e.col_order=h.parents(".themify_builder_col").index());e.component_name=a}this.model.setData(e);d.vent.trigger("dom:builder:change");"visual"!==this.type&&d.vent.trigger("dom:observer:end",f,{cid:this.model.cid,value:this.model.toJSON()})}},"import":function(a){a.preventDefault();a.stopPropagation();console.log("import");var c=b(a.currentTarget);a=ThemifyBuilderCommon.detectBuilderComponent(c);var e={data:{action:"tfb_imp_component_data_lightbox_options"}};
d.activeModel=d.Models.Registry.lookup(c.closest("[data-cid]").data("cid"));switch(a){case "row":case "sub-row":c=c.closest(".themify_builder_"+a.replace("-","_"));ThemifyBuilderCommon.highlightRow(c);break;case "module":var f=c.closest(".themify_builder_module");b(".themify_builder_module").removeClass("current_selected_module");f.addClass("current_selected_module");break;case "column":case "sub-column":f=c.closest(".themify_builder_col"),c=c.closest("column"===a?".themify_builder_row":".themify_builder_sub_row"),
e.data.indexData={row:c.index(),col:f.index()},ThemifyBuilderCommon.highlightColumn(f)}e.data.component=a;ThemifyBuilderCommon.Lightbox.open(e,null)},"export":function(a){a.preventDefault();a.stopPropagation();console.log("export");var c=this,e="";a=b(a.currentTarget);var f=ThemifyBuilderCommon.detectBuilderComponent(a),h={data:{action:"tfb_exp_component_data_lightbox_options"}};switch(f){case "row":case "sub-row":var g=a.closest(".themify_builder_"+f.replace("-","_")),e=function(){var a=g.index(),
a="row"===f?d.Utils._getRowSettings(g,a):d.Utils._getSubRowSettings(g,a);a.component_name=f;var a=JSON.stringify(a),e=b("#tfb_exp_"+f.replace("-","_")+"_data_field");e.val(a);c._autoSelectInputField(e);e.on("click",function(){c._autoSelectInputField(e)})};break;case "module":var k=a.closest(".active_module"),e=function(){var a=k.data("mod-name"),e=JSON.parse(k.find(".themify_module_settings").find('script[type="text/json"]').text()),a=JSON.stringify({mod_name:a,mod_settings:e,component_name:"module"}),
d=b("#tfb_exp_module_data_field");d.val(a);c._autoSelectInputField(d);d.on("click",function(){c._autoSelectInputField(d)})};break;case "column":case "sub-column":var g=a.closest("column"===f?".themify_builder_row":".themify_builder_sub_row"),l=a.closest(".themify_builder_col"),e=function(){var a=g.index(),a="column"===f?d.Utils._getRowSettings(g,a):d.Utils._getSubRowSettings(g,a),e=l.index(),a=a.cols[e];a.component_name=f;var a=JSON.stringify(a),h=b("#tfb_exp_"+f.replace("-","_")+"_data_field");h.val(a);
c._autoSelectInputField(h);h.on("click",function(){c._autoSelectInputField(h)})}}h.data.component=f;ThemifyBuilderCommon.Lightbox.open(h,e)},actionMenuHover:function(a){a.stopPropagation();var c=b(a.currentTarget);if("touchend"===a.type){a=c.closest(".themify_builder_row");var e=c.closest(".themify_builder_col"),d=c.closest(".themify_builder_module"),h="row_"+a.index();0<e.length&&(h+="_col_"+e.index());0<d.length&&(h+="_mod_"+d.index());this.menuTouched[h]?(c.find(".themify_builder_dropdown").stop(!1,
!0).hide(),a.css("z-index",""),ThemifyPageBuilder.menuTouched=[]):(e=this.$el,e.find(".themify_builder_dropdown").stop(!1,!0).hide(),e.find(".themify_builder_row").css("z-index",""),c.find(".themify_builder_dropdown").stop(!1,!0).show(),a.css("z-index","998"),this.menuTouched=[],this.menuTouched[h]=!0)}else"mouseenter"===a.type?c.find(".themify_builder_dropdown").stop(!1,!0).show():"mouseleave"===a.type&&c.find(".themify_builder_dropdown").stop(!1,!0).hide()},getBuilderID:function(){return this.$el.closest("[data-postid]").data("postid")}});
d.Views.BaseElement.extend=function(a){var b=this,e=Backbone.View.extend.apply(this,arguments);e.prototype.events=_.extend({},this.prototype.events,a.events);e.prototype.initialize=function(){_.isFunction(b.prototype.initialize)&&b.prototype.initialize.apply(this,arguments);_.isFunction(a.initialize)&&a.initialize.apply(this,arguments)};return e};d.Views.Modules["default"]=d.Views.BaseElement.extend({tagName:"div",attributes:function(){return{"class":"themify_builder_module module-"+this.model.get("mod_name")+
" active_module","data-mod-name":this.model.get("mod_name"),"data-cid":this.model.cid}},template:wp.template("builder_module_item"),events:{dblclick:"edit","click .themify_module_options":"edit","click .js--themify_builder_module_styling":"edit","click .themify_module_delete":"delete","click .themify_module_duplicate":"duplicate"},initialize:function(){this.listenTo(this,"edit",this.edit);this.listenTo(this.model,"custom:element:updatestate",this.removeInitialStateClass)},render:function(){this.$el.html(this.template(this.model.toRenderData()));
this.renderInlineData();return this},renderInlineData:function(){this.$(".themify_module_settings").find('script[type="text/json"]').text(JSON.stringify(this.model.get("mod_settings")))},removeInitialStateClass:function(){this.$el.removeClass("tb_module_state_unsaved")},edit:function(a,c){var e=!1;_.isNull(a)||_.isUndefined(a)?e=!0:(a.preventDefault(),this.model.set({styleClicked:b(a.currentTarget).hasClass("themify_builder_module_styling")},{silent:!0}));c=c||!1;d.activeModel=this.model;var f=this,
h=this.model.get("mod_settings");b(".module_menu .themify_builder_dropdown").hide();this.highlightModuleBack(this.$el);c||d.vent.trigger("dom:observer:start",this.$el.closest("[data-postid]"),{cid:d.activeModel.cid,value:{mod_settings:d.activeModel.get("mod_settings")}});var g=function(a){a.setAttribute("data-form-state",c?"new":"edit");if("desktop"!==d.activeBreakPoint){var g=b("#themify_builder_options_styling .tfb_lb_option").map(function(){return b(this).attr("id")}).get();h=_.omit(h,g);!_.isUndefined(h["breakpoint_"+
d.activeBreakPoint])&&_.isObject(h["breakpoint_"+d.activeBreakPoint])&&(h=_.extend(h,h["breakpoint_"+d.activeBreakPoint]))}"visual"===f.type&&d.liveStylingInstance.init(f.$el.children(".module"),h);var k=a.getElementsByClassName("tfb_lb_option"),q,v=!_.isEmpty(h);for(q=0;q<k.length;++q){g=b(k[q]);var p=g.attr("id");var m=h[p];g.hasClass("themify-gradient")?d.Utils.createGradientPicker(g,m):g.hasClass("tf-radio-input-container")&&g.find(":checked").trigger("change");if(m)if(g.hasClass("select_menu_field"))isNaN(m)?
g.find("option[value='"+m+"']").attr("selected","selected"):g.find("option[data-termid='"+m+"']").attr("selected","selected");else if(g.is("select"))g.val(m).trigger("change");else if(g.hasClass("themify-builder-uploader-input")){p=m;var u=b("<img/>",{src:p,width:50,height:50});p?(g.val(p),g.parent().find(".img-placeholder").empty().html(u).parent().show()):g.parent().find(".thumb_preview").hide()}else if(g.hasClass("themify-option-query-cat")){p=g.parent();var u=p.find(".query_category_multiple"),
x=m.split("|")[0];p.find("option[value='"+x+"']").attr("selected","selected");u.val(x)}else if(g.hasClass("themify_builder_row_js_wrapper")){p=0;d.cache.repeaterElements[g.attr("id")]=g.find(".tb_repeatable_field").first().clone();0<m.length&&(p=m.length-1);for(u=0;u<p;u++)g.parent().find(".add_new a").first().trigger("click");g.find(".tb_repeatable_field").each(function(a){b(this).find(".tfb_lb_option_child").each(function(c){c=b(this);var e=c.attr("id"),f=c.hasClass("tfb_lb_wp_editor")?c.attr("name"):
c.data("input-id");f||(f=e);e=m[a][""+f+""];if(c.hasClass("themify-builder-uploader-input")){var g=b("<img/>",{src:e,width:50,height:50});e?(c.val(e),c.parent().find(".img-placeholder").empty().html(g).parent().show()):c.parent().find(".thumb_preview").hide()}else if(c.hasClass("tf-radio-choice"))c.find("input[value='"+e+"']").attr("checked","checked").trigger("change");else if(c.hasClass("themify-layout-icon"))c.find("#"+e).addClass("selected");else if(c.hasClass("themify-checkbox"))for(g in e)c.find("input[value='"+
e[g]+"']").prop("checked",!0);else c.is("input, textarea, select")&&c.val(e);c.hasClass("tfb_lb_wp_editor")&&d.Views.init_control("wp_editor",{el:c});c.data("control-binding")&&c.data("control-type")&&d.Views.init_control(c.data("control-type"),{el:c,binding_type:c.data("control-binding")})})})}else if(g.hasClass("tf-radio-input-container"))g.find("input[value='"+m+"']").attr("checked","checked").trigger("change"),p=g.find('input[name="'+p+'"]:checked').val(),g.hasClass("tf-option-checkbox-enable")&&
(g.find(".tf-group-element").hide(),g.find(".tf-group-element-"+p).show());else if(g.is('input[type!="checkbox"][type!="radio"], textarea'))g.val(m).trigger("change"),!c&&g.is("textarea")&&g.hasClass("tf-thumbs-preview")&&f.getShortcodePreview(g,m);else if(g.hasClass("themify-checkbox")){var w=m,w=w.split("|");g.find(".tf-checkbox").each(function(){b(this).prop("checked",-1!==b.inArray(b(this).val(),w))})}else g.hasClass("themify-layout-icon")?g.find("#"+m).addClass("selected"):g.html(m);else g.hasClass("themify-layout-icon")?
g.children().first().addClass("selected"):g.hasClass("themify-builder-uploader-input")?g.parent().find(".thumb_preview").hide():g.hasClass("tf-radio-input-container")?(g.find('input[type="radio"]').first().prop("checked"),p=g.find('input[name="'+p+'"]:checked').val(),g.hasClass("tf-option-checkbox-enable")&&(g.find(".tf-group-element").hide(),g.find(".tf-group-element-"+p).show())):g.hasClass("themify_builder_row_js_wrapper")?(d.cache.repeaterElements[g.attr("id")]=g.find(".tb_repeatable_field").first().clone(),
g.find(".tb_repeatable_field").each(function(a){b(this).find(".tfb_lb_option_child").each(function(a){a=b(this);a.hasClass("tfb_lb_wp_editor")&&d.Views.init_control("wp_editor",{el:a});a.data("control-binding")&&a.data("control-type")&&d.Views.init_control(a.data("control-type"),{el:a,binding_type:a.data("control-binding")})})})):g.hasClass("themify-checkbox")&&v?g.find(".tf-checkbox").each(function(){b(this).prop("checked",!1)}):g.is('input[type!="checkbox"][type!="radio"], textarea')&&v&&g.val("");
g.hasClass("tfb_lb_wp_editor")&&d.Views.init_control("wp_editor",{el:g});g.hasClass("themify_builder_row_js_wrapper")&&d.Views.init_control("repeater",{el:g,binding_type:g.data("control-binding")});g.data("control-binding")&&g.data("control-type")&&"repeater"!==g.data("control-type")&&d.Views.init_control(g.data("control-type"),{el:g,binding_type:g.data("control-binding")})}b("body").trigger("editing_module_option",[h]);b(".tf-option-checkbox-enable input:checked").trigger("change");f.model.get("styleClicked")&&
b('a[href="#themify_builder_options_styling"]').length&&b('a[href="#themify_builder_options_styling"]').trigger("click");e&&"gallery"===f.model.get("mod_name")&&b(".tf-gallery-btn",a).trigger("click");d.Utils.setColorPicker(a);d.Utils.builderPlupload("normal");f.moduleOptionsBinding();b(".themify_builder_tabs").tabs();f.applyAll_init();ThemifyBuilderCommon.fontPreview(b("#themify_builder_lightbox_container"),h);"visual"===f.type&&(ThemifyBuilderCommon.Lightbox.rememberRow(f),d.liveStylingInstance.addStyleDate(f.model.get("mod_name"),
themifyBuilder.element_style_rules[f.model.get("mod_name")]),d.styleSheet.rememberRules())};ThemifyBuilderCommon.highlightRow(this.$el.closest(".themify_builder_row"));ThemifyBuilderCommon.Lightbox.open({loadMethod:"inline",templateID:"builder_form_module_"+this.model.get("mod_name")},function(a){setTimeout(function(){g(a)},400)})},"delete":function(a){a.preventDefault();confirm(themifyBuilder.i18n.moduleDeleteConfirm)&&(a=this.$el.closest("[data-postid]"),d.vent.trigger("dom:observer:start",a),this.switchPlaceholdModule(this.$el),
this.model.destroy(),d.vent.trigger("dom:observer:end",a),d.vent.trigger("dom:builder:change"))},duplicate:function(a){a.preventDefault();a=d.Views.init_module(this.model.toJSON(),this.type);var b=this.$el.closest("[data-postid]");d.vent.trigger("dom:observer:start",b);a.view.render().$el.insertAfter(this.$el);"visual"!==this.type&&(d.vent.trigger("dom:builder:change"),d.vent.trigger("dom:observer:end",b));a.view.trigger("component:duplicate")}});d.Views.Columns["default"]=d.Views.BaseElement.extend({tagName:"div",
...
{cid:d.activeModel.cid,value:{styling:d.activeModel.get("styling")}});ThemifyBuilderCommon.highlightColumn(this.$el);ThemifyBuilderCommon.highlightRow(this.$el.closest(".themify_builder_row"));ThemifyBuilderCommon.Lightbox.open({loadMethod:"inline",templateID:"builder_form_column"},function(){d.Mixins.Builder.editComponent("column",b)})},click_menu_icon:function(a){a.preventDefault()},showModPanel:function(a){a.preventDefault();d.toolbar._show_module_panel()}});d.Views.SubRows["default"]=d.Views.BaseElement.extend({tagName:"div",
attributes:function(){return{"class":"themify_builder_sub_row module_subrow clearfix  module_subrow_"+this.model.cid+" tb_element_cid_"+this.model.cid,"data-column-alignment":this.model.get("column_alignment"),"data-desktop_dir":this.model.get("desktop_dir"),"data-tablet_dir":this.model.get("tablet_dir"),"data-mobile_dir":this.model.get("mobile_dir"),"data-mobile":this.model.get("col_mobile"),"data-tablet":this.model.get("col_tablet"),"data-gutter":this.model.get("gutter"),"data-cid":this.model.cid,
"data-fullwidthvideo":this.model.get("fullwidthvideo"),"data-mutevideo":this.model.get("mutevideo"),"data-unloopvideo":this.model.get("unloopvideo")}},template:wp.template("builder_sub_row_item"),events:{"click .themify_builder_style_subrow":"edit","click .sub_row_delete":"delete","click .sub_row_duplicate":"duplicate"},initialize:function(){this.listenTo(this.model,"change:styling",this.renderInlineData)},render:function(){this.$el.html(this.template(this.model.toJSON()));this.renderInlineData();
if(!_.isUndefined(this.model.get("cols"))){var a=document.createDocumentFragment();_.each(this.model.get("cols"),function(b,c){b.component_name="sub-column";_.isObject(b.styling)&&(b.styling=d.Utils.removeEmptyFields(b.styling));var e=d.Views.init_column(b,this.type);a.appendChild(e.view.render().el)},this);this.$el.find(".themify_builder_sub_row_content").append(a)}var c={},e=this.model.get("col_tablet"),f=this.model.get("col_mobile"),h=this.$el.find(".themify_builder_sub_row_content");c.desktop=
...
" "+f+" "+e);return this},renderInlineData:function(){var a=this.model.get("styling"),b="",e="",d="";_.isObject(a)&&(b=_.isEmpty(a.background_video)||"video"!==a.background_type?"":a.background_video)&&!_.isEmpty(a.background_video_options)&&(e=-1!==a.background_video_options.indexOf("mute")?"mute":"",d=-1!==a.background_video_options.indexOf("unloop")?"unloop":"");this.$el.attr({"data-fullwidthvideo":b,"data-mutevideo":e,"data-unloopvideo":d});this.$el.find(".gutter_select").val(this.model.get("gutter"));
