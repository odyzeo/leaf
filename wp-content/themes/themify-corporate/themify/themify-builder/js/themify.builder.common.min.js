var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,f,h){b instanceof String&&(b=String(b));for(var l=b.length,a=0;a<l;a++){var c=b[a];if(f.call(h,c,a,b))return{i:a,v:c}}return{i:-1,v:void 0}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(b,f,h){b!=Array.prototype&&b!=Object.prototype&&(b[f]=h.value)};$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};
$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(b,f,h,l){if(f){h=$jscomp.global;b=b.split(".");for(l=0;l<b.length-1;l++){var a=b[l];a in h||(h[a]={});h=h[a]}b=b[b.length-1];l=h[b];f=f(l);f!=l&&null!=f&&$jscomp.defineProperty(h,b,{configurable:!0,writable:!0,value:f})}};$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,h){return $jscomp.findInternal(this,b,h).v}},"es6-impl","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
...
$jscomp.iteratorPrototype=function(b){$jscomp.initSymbolIterator();b={next:b};b[$jscomp.global.Symbol.iterator]=function(){return this};return b};$jscomp.iteratorFromArray=function(b,f){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var h=0,l={next:function(){if(h<b.length){var a=h++;return{value:f(a,b[a]),done:!1}}l.next=function(){return{done:!0,value:void 0}};return l.next()}};l[Symbol.iterator]=function(){return l};return l};
...
d&&!b(this).hasClass("themify_builder_font_loaded")){var h=b(this),k=h.index();h.addClass("themify_builder_font_loaded");f=f.children("span");-1===b.inArray(d,g.fonts)&&(f.addClass("themify_show_wait"),"webfont"!==a.find('option[value="'+d+'"]').data("type")?WebFont.load({google:{families:[d]},fontloading:function(a,b){g.fonts.push(d);f.removeClass("themify_show_wait")},fontinactive:function(a,b){g.fonts.push(d);f.removeClass("themify_show_wait")}}):(g.fonts.push(d),f.removeClass("themify_show_wait")));
e(k,d,f)}}})}function e(a,c){b(".themify-combo-dropdown").find("li:eq("+a+")").addClass("themify_builder_font_loaded").css("font-family",c)}this.autoComplete();this.hideShowBorder(a);this.hideShowSliderArrow(a);this.hideShowBackgroundZoom(a);var g=ThemifyBuilderCommon,k="",h="";if(0===Object.keys(g.safe_fonts).length){for(var f in themify_builder_plupload_init.fonts.safe)""!==themify_builder_plupload_init.fonts.safe[f].value&&"default"!==themify_builder_plupload_init.fonts.safe[f].value&&(g.safe_fonts[themify_builder_plupload_init.fonts.safe[f].value]=
...
if(!k){for(var a in g.safe_fonts){var c=e===a?'selected="selected"':"";k+="<option "+c+' data-type="webfont" value="'+a+'">'+g.safe_fonts[a]+"</option>"}for(a in g.google_fonts)c=e===a?'selected="selected"':"",h+="<option "+c+' value="'+a+'">'+g.google_fonts[a]+"</option>"}f.first().html(k);f.last().html(h);d(b(this).children("select"))});e&&(g.safe_fonts[e]?f.first().html('<option selected="selected" data-type="webfont" value="'+e+'">'+g.safe_fonts[e]+"</option>"):g.google_fonts[e]&&f.last().html('<option selected="selected"  value="'+
e+'">'+g.google_fonts[e]+"</option>"))});if(0<g.fonts.length){var l=b(".themify-combo-dropdown").first();for(f in g.fonts){var m=l.find('[data-value="'+g.fonts[f]+'"]').index();e(m,g.fonts[f])}}b(".themify-combo-arrow").unbind("click").click(function(){b(".themify_builder_font_preview").hide()})},Lightbox:{$lightbox:null,setup:function(){function a(){750<parseInt(c.$lightbox.width())?c.$lightbox.addClass("larger-lightbox"):c.$lightbox.removeClass("larger-lightbox")}var c=ThemifyBuilderCommon.Lightbox,
...
a.clickCheckboxOption).on(d,'#tfb_module_settings input[type="text"], #tfb_module_settings textarea',a.focusInput).on("change","#tfb_module_settings .query_category_single",function(){b(this).closest(".themify_builder_input").find(".query_category_multiple").val(b(this).val())}).on(d,".reset-styling",a.resetStyling);themifyBuilder.disableShortcuts||a.controlByKeyInput()},adjustHeight:function(a){ThemifyBuilderCommon.Lightbox.$lightbox.find(".themify_builder_options_tab_wrapper").css("height",a-55)},
fixContainment:function(){var a=ThemifyBuilderCommon.Lightbox,c=a.$lightbox.outerWidth(),d=b(f).width(),e=b(f).height(),c=[-c+20,0,d-20,e-30],d=a.$lightbox.position(),e={};d.left<c[0]&&(e.left=c[0]);0>d.top&&(e.top=0);d.left>c[2]&&(e.left=c[2]);d.top>c[3]&&(e.top=c[3]);a.$lightbox.css(e)},open:function(a,c){var d=ThemifyBuilderCommon.Lightbox,e=b("#themify_builder_lightbox_container");ThemifyBuilderCommon.isFrontend()&&themifybuilderapp.Frontend.hideModulesControl();themifybuilderapp.toolbar.trigger("hide-distraction-panel");
this._cleanLightBoxContent();d.$lightbox.addClass("tfb-lightbox-open");b("#themify_builder_overlay").show();ThemifyBuilderCommon.showLoader("show");if(a.loadMethod&&"inline"===a.loadMethod){var g=ThemifyBuilderCommon.templateCache.get("tmpl-"+a.templateID);d.openCallback(g,e,c)}else a.data=_.extend(a.data||{},{nonce:themifyBuilder.tfb_load_nonce}),a=_.defaults(a||{},{type:"POST",url:themifyBuilder.ajaxurl}),b.ajax(a).done(function(a){d.openCallback(a,e,c)})},openCallback:function(a,c,d){var e=ThemifyBuilderCommon.Lightbox,
g="themify_builder_lightbox_frontend_pos_size";ThemifyBuilderCommon.isFrontend()||(g="themify_builder_lightbox_backend_pos_size");var k=localStorage.getItem(g),g={top:100,left:Math.max(0,b(f).width()/2-300),width:600,height:500};null!==k&&(g=JSON.parse(k));e.$lightbox.show().css({top:g.top,left:g.left,width:g.width,height:g.height}).addClass("animated fadeIn").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(a){e.fixContainment();b(this).removeClass("animated fadeIn")});
b(h).on("keyup",e.cancelKeyListener);ThemifyBuilderCommon.showLoader("spinhide");a=b(a);k=a.find("#themify_builder_lightbox_options_tab_items");0<k.length&&(b(".themify_builder_options_tab").append(k.children()),k.remove());k=a.find("#themify_builder_lightbox_actions_items");0<k.length&&(b(".themify_builder_lightbox_actions").append(k.children()),k.remove());c.append(a);e.$lightbox.find(".themify_builder_options_tab_wrapper").each(function(){new SimpleBar(this)});e.adjustHeight(g.height);e.$lightbox.show();
b("#themify_builder_lightbox_container").find("select").not(".font-family-select").wrap('<div class="selectwrapper"></div>');b(".selectwrapper").click(function(){b(this).toggleClass("clicked")});b.isFunction(d)&&d.call(this,a[0]);ThemifyBuilderCommon.setUpTooltip()},close:function(){var a=ThemifyBuilderCommon.Lightbox,c=b("form#tfb_module_settings");b(h).off("keyup",a.cancelKeyListener);"undefined"!==typeof tinyMCE&&c.find(".tfb_lb_wp_editor").each(function(){var a=b(this).prop("id");switchEditors.go(a,
"tmce");themifybuilderapp.Views.ControlRegistry.lookup(a).resetEditor()});ThemifyBuilderCommon.isFrontend()&&(a.forgetRow(),null!==themifybuilderapp.liveStylingInstance&&themifybuilderapp.liveStylingInstance.remove(),themifybuilderapp.Frontend.showColumnsBorder());themifybuilderapp.toolbar.trigger("show-distraction-panel");a.$lightbox.fadeOut(function(c){b(this).removeClass("animated fadeOut");a._cleanLightBoxContent();b("#themify_builder_overlay, #themify_builder_lightbox_parent").hide();a.$lightbox.removeClass("tfb-lightbox-open");
themifybuilderapp.vent.trigger("dom:builder:change")})},_cleanLightBoxContent:function(){b("#themify_builder_lightbox_container").children().remove().end().empty();this.$lightbox.find(".themify_builder_options_tab").empty();this.$lightbox.find(".themify_builder_lightbox_actions").children().not(".builder_cancel_lightbox").remove()},controlByKeyInput:function(){b(h).on("keydown",function(a){if(83==a.which&&(1==a.ctrlKey||1==a.metaKey)){var c=h.activeElement.tagName.toLowerCase();if("input"!=c&&"textarea"!=
c){a.preventDefault();c=b("#builder_submit_module_settings");var d=b("#builder_submit_row_settings"),e=b("#builder_submit_subrow_settings"),g=b("#builder_submit_column_settings"),f=b("#tb_toolbar").find(".tb_toolbar_save");0<c.length?c.trigger("click"):0<d.length?d.trigger("click"):0<e.length?e.trigger("click"):0<g.length?g.trigger("click"):0<f.length&&f.is(":visible")&&f.trigger("click")}}90==a.which&&(1==a.ctrlKey&&1==a.shiftKey||1==a.metaKey&&1==a.shiftKey)?(c=h.activeElement.tagName.toLowerCase(),
"input"!=c&&"textarea"!=c&&(a.preventDefault(),b(".js-themify-builder-redo-btn").length&&b(".js-themify-builder-redo-btn").trigger("click"))):90!=a.which||1!=a.ctrlKey&&1!=a.metaKey||(c=h.activeElement.tagName.toLowerCase(),"input"!=c&&"textarea"!=c&&(a.preventDefault(),b(".js-themify-builder-undo-btn").length&&b(".js-themify-builder-undo-btn").trigger("click")))})},rememberedRow:null,rememberedCid:null,rememberRow:function(a){var b=ThemifyBuilderCommon.Lightbox;b.rememberedRow=a.$el[0].outerHTML;
b.rememberedCid=a.model.cid;"module"===a.model.get("elType")&&a.model.trigger("custom:restoredata")},revertToRememberedRow:function(){var a=ThemifyBuilderCommon.Lightbox,b=themifybuilderapp.Models.Registry.lookup(a.rememberedCid);b&&b.trigger("custom:restorehtml",a.rememberedRow);a.rememberedRow=null;a.rememberedCid=null},forgetRow:function(){var a=ThemifyBuilderCommon.Lightbox;a.rememberedRow=null;a.rememberedCid=null},previewButtonClicked:function(a){return a.hasClass("builder_preview_lightbox")},
showPreviewBtn:function(){b(".builder_button.builder_preview_lightbox").show()},hidePreviewBtn:function(){b(".builder_button.builder_preview_lightbox").hide()},clickRadioOption:function(a){a=ThemifyBuilderCommon.getCheckedRadioInGroup(b(this),ThemifyBuilderCommon.Lightbox.$lightbox);var c=b('input[name="'+a.prop("name")+'"]',ThemifyBuilderCommon.Lightbox.$lightbox);a=a.data("selected");c.each(function(){b(this).closest(".themify_builder_row_content").length?b(this).closest(".themify_builder_row_content").find(".tf-group-element-"+
b(this).val()).hide():b(".tf-group-element-"+b(this).val()).hide()});b(this).closest(".themify_builder_row_content").length?b(this).closest(".themify_builder_row_content").find("."+a).show():b("."+a).show();b(".thumb_preview").each(function(){0===b(this).find("img").length&&b(this).hide()})},clickCheckboxOption:function(a){b(".tf-checkbox-element").hide();b(this).parent(".themify-checkbox").find("input:checked").each(function(){b(".tf-checkbox-element."+b(this).data("selected")).show()})},cancelKeyListener:function(a){var b=
ThemifyBuilderCommon.Lightbox;27==a.keyCode&&(a.preventDefault(),b.cancel(a))},cancel:function(a){a.preventDefault();a=ThemifyBuilderCommon.Lightbox;null!==a.rememberedRow&&a.revertToRememberedRow();ThemifyBuilderCommon.isFrontend()&&themifybuilderapp.styleSheet.revertRules();ThemifyBuilderCommon.undoManager.startValue=null;ThemifyBuilderCommon.undoManager.startData={};a.close()},focusInput:function(a){b(this).focus()},resetStyling:function(a){a.preventDefault();a=b(this).data("reset");var c=null;
"module"===a?c=b("#themify_builder_options_styling"):"row"===a?c=b("#tfb_row_settings"):"subrow"===a?c=b("#tfb_subrow_settings"):"column"===a&&(c=b("#tfb_column_settings"));var d=[];c.find(".tfb_lb_option:not(.exclude-from-reset-field)").each(function(){var a=b(this);if("radio"===a.attr("type")){var c=a.attr("name");-1===d.indexOf(c)&&d.push(c)}else a.val("").prop("selected",!1).trigger("change");a.hasClass("themify-builder-uploader-input")?a.parent().find(".img-placeholder").html("").parent().hide():
a.hasClass("font-family-select")?a.val("default").trigger("change"):a.hasClass("builderColorSelectInput")&&(a.parent().find(".colordisplay").val("").trigger("blur").trigger("change"),a.parent().find(".opacity-input").val(""))});d.forEach(function(a){b('input:radio[name="'+a+'"]:first',c).attr("checked",!0).trigger("change")})},switchTabs:function(a){var c=ThemifyBuilderCommon.Lightbox,d=b(this);a.preventDefault();b(this).addClass("current");setTimeout(function(){d.siblings().removeClass("current")},
10);a=b(this).find("a").attr("href");b(a).show().siblings(".themify_builder_options_tab_wrapper").hide();ThemifyBuilderCommon.isFrontend()&&c.handleDisplayOfPreviewBtn(a)},selectDefaultTab:function(a){a=ThemifyBuilderCommon.Lightbox;b(".themify_builder_options_tab_wrapper").hide().first().show();var c=b("ul.themify_builder_options_tab li:first");c.addClass("current");ThemifyBuilderCommon.isFrontend()&&(c=c.find("a").attr("href"),a.handleDisplayOfPreviewBtn(c))},handleDisplayOfPreviewBtn:function(a){var b=
ThemifyBuilderCommon.Lightbox;"#themify_builder_options_setting"===a?b.showPreviewBtn():b.hidePreviewBtn()}},undoManager:{instance:new UndoManager,events:b({}),startValue:null,startData:{},startStyleValue:null,set:function(a,b,d,e,g,f){if(!_.isNull(f)&&_.isObject(f)){var c=f.startValue;var h=f.newValue}ThemifyBuilderCommon.undoManager.instance.add({undo:function(){a[0].innerHTML=b;themifybuilderapp.vent.trigger("dom:observer:update",a);if(!_.isEmpty(e)){var d=themifybuilderapp.Models.Registry.lookup(e.cid);
d&&(d.set(e.value,{silent:!0}),d.unset("temp_settings",{silent:!0}))}_.isUndefined(c)||themifybuilderapp.styleSheet.replaceCSSText(c)},redo:function(){a[0].innerHTML=d;themifybuilderapp.vent.trigger("dom:observer:update",a);if(!_.isEmpty(g)){var b=themifybuilderapp.Models.Registry.lookup(g.cid);b&&(b.set(g.value,{silent:!0}),b.unset("temp_settings",{silent:!0}))}_.isUndefined(h)||themifybuilderapp.styleSheet.replaceCSSText(h)}});ThemifyBuilderCommon.undoManager.startValue=null;ThemifyBuilderCommon.undoManager.startData=
{};ThemifyBuilderCommon.undoManager.startStyleValue=null},setStartValue:function(a){ThemifyBuilderCommon.undoManager.startValue=a},getStartValue:function(){return ThemifyBuilderCommon.undoManager.startValue},setStartData:function(a){ThemifyBuilderCommon.undoManager.startData=a},getStartData:function(){return ThemifyBuilderCommon.undoManager.startData},setStartStyleValue:function(a){ThemifyBuilderCommon.undoManager.startStyleValue=a},getStartStyleValue:function(){return ThemifyBuilderCommon.undoManager.startStyleValue}},
LiteLightbox:{modal:new wp.media.view.Modal({controller:{trigger:function(){}}}),confirmView:wp.Backbone.View.extend({template:wp.template("builder_lite_lightbox_confirm"),className:"themify_builder_lite_lightbox_content",initialize:function(a){this.options=a||{}},render:function(){this.$el.html(this.template({message:this.options.message,buttons:this.options.buttons}))},events:{"click button":"buttonClick"},buttonClick:function(a){a.preventDefault();a=b(a.currentTarget).data("type");this.trigger("litelightbox:confirm",
a)}}),promptView:wp.Backbone.View.extend({template:wp.template("builder_lite_lightbox_prompt"),className:"themify_builder_lite_lightbox_content",initialize:function(a){this.options=a||{}},render:function(){this.$el.html(this.template(this.options))},events:{"click button":"buttonClick","keypress .themify_builder_litelightbox_prompt_input":"keyPress"},buttonClick:function(a){a.preventDefault();a=b(a.currentTarget).data("type");var c=this.$el.find(".themify_builder_litelightbox_prompt_input").val();
this.trigger("litelightbox:prompt",a,c)},keyPress:function(a){13===a.which&&(a=b(a.currentTarget).val(),this.trigger("litelightbox:prompt","ok",a))}}),confirm:function(a,c,d){d=_.defaults(d||{},{buttons:{no:{label:"No"},yes:{label:"Yes"}}});d.message=a;a=new ThemifyBuilderCommon.LiteLightbox.confirmView(d);ThemifyBuilderCommon.LiteLightbox.modal.content(a);ThemifyBuilderCommon.LiteLightbox.modal.open();a.on("litelightbox:confirm",function(a){ThemifyBuilderCommon.LiteLightbox.modal.close();b.isFunction(c)&&
c.call(this,a)})},prompt:function(a,c,d){d=_.defaults(d||{},{buttons:{cancel:{label:"Cancel"},ok:{label:"OK"}}});d.message=a;a=new ThemifyBuilderCommon.LiteLightbox.promptView(d);ThemifyBuilderCommon.LiteLightbox.modal.content(a);ThemifyBuilderCommon.LiteLightbox.modal.open();a.on("litelightbox:prompt",function(a,d){ThemifyBuilderCommon.LiteLightbox.modal.close();b.isFunction(c)&&c.call(this,"cancel"==a?null:d)})},alert:function(a){ThemifyBuilderCommon.LiteLightbox.confirm(a,null,{buttons:{yes:{label:"OK"}}})}},
getDomPath:function(a){for(var b=[];null!=a.parentNode;){for(var d=0,e=0,f=0;f<a.parentNode.childNodes.length;f++){var h=a.parentNode.childNodes[f];h.nodeName==a.nodeName&&(h===a&&(e=d),d++)}a.hasAttribute("id")&&""!=a.id?b.unshift(a.nodeName.toLowerCase()+"#"+a.id):1<d?b.unshift(a.nodeName.toLowerCase()+":eq("+e+")"):b.unshift(a.nodeName.toLowerCase());a=a.parentNode}return b.slice(1)},getColClassName:function(a){a=a.prop("class").split(" ");for(var b="col-full",d=0;d<a.length;d++){var e=/^col([0-9]+)\-([0-9]+)/.exec(a[d]);
null!=e&&(b=e[0])}return b},templateCache:{get:function(a){this.templates||(this.templates={});var b=this.templates[a];b||(b=h.getElementById(a).innerHTML,this.templates[a]=b);return b}},randNumber:function(){this.uuid++;return this.uuid+"-"+Math.random().toString(36).substr(2,7)}}})(jQuery,window,document);
