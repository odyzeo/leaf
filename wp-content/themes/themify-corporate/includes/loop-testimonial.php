...
<article id="testimonial-<?php the_id(); ?>" <?php post_class('post clearfix testimonial-post'); ?>>
	...
	if ( $testimonial_author || $testimonial_title ) : ?>
		...
		<p class="testimonial-author">
			<?php echo $before . '&mdash; <span>' . $testimonial_author . '</span>'. $after; ?><?php if ($testimonial_title) : ?><span class="testimonial-title"><?php echo $testimonial_title; ?></span><?php endif; ?>
		</p>
		<!-- /.testimonial-author -->
		<?php themify_after_post_title(); // hook ?>
	<?php endif; ?>
