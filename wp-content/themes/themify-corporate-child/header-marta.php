...
<div id="pagewrap" class="hfeed site <?php echo $page_class; ?>">
    ...
    <?php get_template_part( 'template-parts/slide-menu', 'marta' ); ?>

    <header class="wrapper header header--award js-header">
        <a href="//leaf.sk/marta" class="header__logo header__logo--absolute">
            <img class="logo-leaf"
                 src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/leaf-logo.svg"
                 alt="LEAF">
        </a>
        <div class="container header__container">
            <a href="//leaf.sk/marta" class="header__logo header__logo--desktop">
                <img class="logo-leaf"
                     src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/leaf-logo.svg"
                     alt="LEAF">
            </a>
            <div class="header__menu">
                ...
                <?php if ( has_nav_menu( 'marta-nav' ) ) :
                    wp_nav_menu( array(
                        'container'      => false,
                        'theme_location' => 'marta-nav',
